...
--question 1
SELECT SUM(count) as SUM_Of_Title_Counts
...
Dept_emp.to_date,
Titles.title
--INTO mentorship_eligibility_from_1960s
FROM Employees
INNER JOIN dept_emp
	ON (Employees.emp_no = dept_emp.emp_no)
INNER JOIN Titles
	ON (Employees.emp_no = Titles.emp_no)
WHERE (dept_emp.to_date = '9999-01-01') 
AND (Employees.birth_date BETWEEN '1960-01-01' AND '1965-12-31')
ORDER BY Employees.emp_no;


SELECT COUNT(dept_emp) FROM mentorship_eligibility_from_1960s;
